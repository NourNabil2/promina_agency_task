              ...
              children: [
                ...
                Container(
                  margin: Responsive.isTablet(context) == true
                      ? const EdgeInsets.symmetric(horizontal: ValueApp.margin_250)
                      : const EdgeInsets.all(ValueApp.margin_30),
                  padding: Responsive.isTablet(context) == true
                      ? const EdgeInsets.all(ValueApp.kPadding_120)
                      : const EdgeInsets.all(ValueApp.kPadding_20),
